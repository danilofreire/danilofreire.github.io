...
\begin{minipage}{0.45\linewidth}
	...
	\begin{itemize}
		\item Substantive: Collective Action, Political Violence, Public Policy, Brazilian Politics
		\item Methodological: Impact Evaluation, Field Experiments, Meta-Analysis, Computational Social Science 
	\end{itemize}
	...
	\begin{itemize}
		\item Research Grant, Konrad Adenauer Stiftung, 2019. Joint with D. Skarbek and U. Mignozzetti (US\$ 60,000).
	...
	\begin{itemize}
		\item R, Stata, Stan, JAGS, Atlas.ti, git, HTML, Jekyll, Markdown, \LaTeX{}.
	\end{itemize}
