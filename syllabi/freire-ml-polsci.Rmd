...
This course is an overview of recent developments in the machine learning literature and their applications in political science. First, students will learn how to summarise and visualise data, create reproducible documents, and use version control software. Then, we will discuss how to impute missing values and select features. After that, we will consider supervised learning methods, including OLS, generalised linear models for classification, support vector machines, decision trees, random forests, and gradient boosting. This will be followed by classes on unsupervised learning algorithms such as PCA and clustering. The fourth section of this course will cover deep learning and neural networks. Lastly, we will briefly discuss the recent developments in causal discovery methods.
...
* Wickham, H., & Grolemund, G. (2016). [R for Data Science: Import, Tidy, Transform, Visualize, and Model Data](https://r4ds.had.co.nz/), New York: O'Reilly Media, Inc.
...
## Week 2: Importing and Visualise Data 
...
## Week 3: Introduction to Supervised Learning, Basic Model Selection. Linear Models for Regression

### Required Readings

* Kuhn, M., & Johnson, K. (2013). [Applied Predictive Modeling](http://appliedpredictivemodeling.com/), New York: Springer. Chapters 3 and 6. 
...
* Kuhn, M., & Johnson, K. (2013). [Applied Predictive Modeling](http://appliedpredictivemodeling.com/), New York: Springer. Chapter 13.4, 18, and 19.
...
* Jones, Z., & Linder, F. (2015, April). [Exploratory Data Analysis Using Random Forests](http://zmjones.com/static/papers/rfss_manuscript.pdf), In: Prepared for the 73rd annual MPSA conference.
...
## Week 7: Discussion of Final Projects

No readings assigned for this session.

## Week 8: Model Evaluation and Imbalanced Datasets
...
## Week 9: Dimensionality Reduction using PCA, Clustering, and Manifold Learning
...
## Week 10: Working with Text as Data
...
* Barberá et al (2019). [Automated Text Classification of News Articles: A Practical Guide](http://www.pablobarbera.com/static/text_practical_guide.pdf), Working paper.
...
## Week 11: Neural Networks, Convolutional Neural Networks for Image Classification

### Required Readings 

* Chollet, F., & Allaire, J. J. (2018). [Deep Learning with R](https://livebook.manning.com/book/deep-learning-with-r/about-this-book/3), New York: O'Reilly Media, Inc. Chapters, 1-3, 5.
* RStudio Team (2019). [R Interface to Keras](https://keras.rstudio.com/).

## Week 12: More on Neural Networks 

### Required Readings 

* Johnson, J. & Karpathy, A. (2019). [Stanford CNN Course Notes, Module 2](http://cs231n.github.io/).

## Week 13: Introduction to Causal Discovery Algorithms
...
* Freire, D. (2019). Uncovering Causal Relations in Observational Data Using Machine Learning and Graphic Models. Working paper.
